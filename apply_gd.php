...
<head>
   ...
   <title>BU RADiO - Graphics Designer Hunt Registration Form</title>
   ...
   <form method="post" enctype="multipart/form-data">
      <div class="wrapper">
         ...
         <div class="form" id="regform" style="display:none">
            ...
            <div class="inputfield">
               <input type="text" name="fullname" class="input" value="Graphics Designer" readonly>
            </div>
            ...
            <div class="inputfield">
               <label>Give us some of your work links: (Youtube/ Google Drive/ Github etc.)<a style="color:red"> *</a></label>
            </div>
            <div class="inputfield">
               <textarea class="textarea" name="worklink" required></textarea>
            </div>
            <!--- 
      <div class="inputfield terms">
          <label class="check">
          ...
          <p>Agreed to <a href="/rjhunt/terms.php" target="_blank">terms and conditions</a></p>
            ...
            <div style="padding-top:50px;">
               <label>
                  <p class="copy-right">&copy; copyright 2019-2020, Developed By <a href="http://abuubaida921.com/" target="_blank">Abu Ubaida</a> & Maintained By <a href="https://buradio.org/" target="_blank">BU RADiO</a></p>
               </label>
            </div>
         </div>
      </div>
...
if (isset($_POST["submit"])) {
   ...
   $worklink = htmlspecialchars($_POST['worklink']);
   ...
   $worklink = mysqli_real_escape_string($conn, $worklink);
   ...
   if ($checkrows > 0) {
      ...
      $sql = "INSERT into radio_q2_hunt_2020 (time_stamp, submission_ip, apply_for, full_name, nick_name, date_of_birth, gender, present_address, permanent_address, department, session, email, phone_number, payment_phone_number, fb_profile, extra_curriculum_activities, why_do_you_want_to_join, why_do_you_want_to_be_rj, can_you_make_friend_easily, opinion_about_radio, pc_status, broadband_status, uploaded_file, worklink, payment, extra_f) 
                        VALUES('$timestamp','$ip','Graphics Designer', '$full_name','$nick_name','$dob','$gender','$present_address','$permanent_address','$dept','$session','$email','$phone','$another_phone','$fb_profile','$eca','$personal_opinion','$why_rj','$opinionaboutfriendmaking','$opinionaboutradio','$pc','$internet','','$worklink','','p')";
